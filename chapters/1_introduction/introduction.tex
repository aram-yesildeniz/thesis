...
[tbd]
What the reader can expect in this chapter 1.1
...
%TODO
% compare both processes directly with a table with 2 columns?
...
Standard formats of log files and entries allow log file analysis software to process, evaluate and report valuable statistics to users, such as \textit{Analog}, \textit{Webalizer} or \textit{AWStats}. %cite 2015 Zheng


% [Pro]
Following are some points describing the advantages and disadvantages of log file analysis.
...
Table X provides "unofficial rule of thumb" thresholds of delay. %cite 2013 Grigorik https://hpbn.co/primer-on-web-performance/
...
Once the test environment is up and running, questions of how to measure performance need to be addressed.
