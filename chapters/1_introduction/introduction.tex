...
%TODO
% Abstract (english and german) and Acknowledgements
...
% percentage: gap between? 10% or 10 %
% seconds, ms: gap between? 10s, 10 s, 123ms, 123 ms
...
% discussed in Section / section, evtl gross ? also figure / Figure
% decide which words italic, bold, etc.
% captions of all listings, tables, figures etc above the content ??
% footnote after dot: "blabal".^1
% fill out all "section X".
% put citation always directly behind name, if it is not a direktes zitat
% page numbers for direct citations!
