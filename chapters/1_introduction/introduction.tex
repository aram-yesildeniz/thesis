...
A lot more services followed, such as \textit{WebSideStory} in 1996 \cite{2015Croll}
...
% [Con]
Some disadvantages of log file analysis are (\cite{2011Marekt}, \cite{2015Zheng}):
...
Croll provides a graphic illustration (figure \ref{img:page_tagging}) of the page tagging process which is explained below \cite{2009Croll}.
