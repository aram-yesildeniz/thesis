...
% 2016 Kohavi
- Offline: Long existing since 1920s
- Online since 1990s with rise of internet, and is widely used also by big companies -> indispensable
- See if there is a difference and ideally support decision making

- Is a scientific method
- Controlled experiment
- "establishing a causal relationship with high probability"
- Helps to test hypothesis and questions of structure: If i change one specific feature / element, will it help to improve X?
- Evaluation with real users

- In practice:
- split users randomly in two groups
- use web analytics to measure metrics

- Elements:
- Control (version a, default variant) and a changed variation called treatment (version B)
- If more than 2 versions or one treatment: A/B/n split test
- Univariable: test one variable at the time
- Multivariable: change more than one variable at the same time


- More details about controlled experiments are in chapter about Controlled Experiments


% 2018 Morys
- Directly test ideas (hypothesis) on production system
- Data driven and quantitative validation
- Participant does not now that he is part of an experiment: no bias
- 5 steps:
...
- Coming back to performance, with A/B testing it is possible to serve two different versions of the same site to two groups, one being slow, the other one fast, at the same time.
With web analytics, it is possible to measure how the different groups behave differently on the two systems.
