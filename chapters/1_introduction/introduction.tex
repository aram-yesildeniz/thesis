...
Now we have a general understanding of the field where the research should happen on.
...
The underlying assumption and hypothesis of this thesis is, that tracking tools slow down the monitored websites, that they decrease speed and performance of the website, and therefore affect user experience unfavourable, which consequently leads to misleading collected data and bad decisions.
The motivation of this thesis is to study and understand negative impact on performance of tracking tools, and thereafter prototype a tracking tool whose negative impact on the websites performance and user experience are as little as possible. The research motivation is to investigate if, and how tracking tools are slowing down websites and which particular features of those tools impact how and why the websites performance.
