...
The information within the log entry can vary depending on the log format,but standardly provided are the users IP, browser, timestamp , time taken, bytes transferred, whether a cache hit occured and the referrer. %cite 2009 Waisberg

The common log format provides:
% TODO as code snippet
127.0.0.1 user-identifier frank [10/Oct/2000:13:55:36 -0700] "GET /apache_pb.gif HTTP/1.0" 200 2326
- NCSA Common Log Format: server IP, date/time, HTTP request command, response status, and response size
- Log analysis software (such as Analog, Deep Log Analyzer, Webalizer, AWStats) %cite 2015 Zheng
...
very technical data, no events, no custom metrics, no business related metrics, etc.
...
% TODO exract those and move to pro and con fields
