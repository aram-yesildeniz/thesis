...
% [User Satisfaction]
The aim of this thesis is not to deep dive into terms and concepts or the problem of defining user satisfaction, usability or the like.
Therefore the term user satisfaction is in this context loosely defined as how happy the user is with the website he interacts with.\footnote{For a more profound discussion cf. "User satisfaction measurement" in } %cite 2010 Islam
...
% [SpeedHub.org]
Speedstudy: Largest study, Baqend with Google
Many studies, reports, collection of videos and blog posts.


% [code.talks 2019]
In his keynote at code talks 2019, Felix Gessert provides an overview. %cite 2019 Gessert

To answer the question between the correlation of user satisfaction and performance, one has to distinguish between different users and their context:
User profile, device and context all play a role how performance is being received.

From a Psychology perspective, studies show that the attention: stay under 1000 ms

Taking a look at real life examples and studies:
There are studies from big companies which prove that site speed impacts revenue.
Amazon, Zalando, Walmart
SEO: GQ, Google, Pinterest
Engagement: Forrester, Otto, Akamai
Satisfaction: radware, AberdeedGroup, Imperial College London

Summary: Page Speed = Money


In order to measure impact of performance in a scientific profound way, we need to to testing, which is possible through A/B Testing, which is described in the next section.
