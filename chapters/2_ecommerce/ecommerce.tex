...
\subsubsection{E-Commerce Types} % korrigiert
...
Jansen \cite{2009Jansen} defines four categories for web analytics metrics. % p. 30 ?
...
Gessert et al. \cite{2020GessertWingerath} propose a semantic categorization of metrics.
...
%	\hline
	...
	\caption[Web Analytics or Business Metrics Examples]{Web Analytics or Business Metrics Examples, taken from \cite{2004Peterson}, \cite{2007Burby}.} % 2004 Peterson,  2007 Burby
