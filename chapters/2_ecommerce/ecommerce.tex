...
% Finally, web performance will be explained in chapter \ref{chapter:web_performance}, which leads the way to the research questions.
...
Log file analysis will be further discussed in section \ref{chapter:log_file}.
...
On the contrary, Waisberg and Kaushik \cite{2009Waisberg} derive a five-step process from industry best practices with the main goal of improving the website and increasing sales: %TODO improve waisberg citation
...
As already mentioned in section \ref{chapter:web_analytics_history}, the two most important methods of data collection are log file analysis and page tagging.
