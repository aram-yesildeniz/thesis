...
Those sources explain the idea and nature of the metrics.
How exactly the metrics are implemented and calculated, e.g. which Navigation Timing attributes are used, is the responsibility of the RUM tools vendors and can only be checked directly in the source code.
...
\begin{center}
	...
	\begin{itemize}[label={}, noitemsep,nolistsep, leftmargin=0cm]
		\item $[responseStart - navigationStart]$
		\item Blablablabla
	\end{itemize} \\	
	...
	TLS Handshake Time &
	\begin{itemize}[label={}, noitemsep,nolistsep, leftmargin=0cm]
		\item $requestStart - secureConnectionStart$
		\item Blablablabla
	\end{itemize} \\

	\hline
	Request / Server Response Time &
	\begin{itemize}[label={}, noitemsep,nolistsep, leftmargin=0cm]
	...
	DOM Content Loaded &
	\begin{itemize}[label={}, noitemsep,nolistsep, leftmargin=0cm]
		\item $domContentLoadedEventEnd - domContentLoadedEventStart$
		\item Blablablabla
	\end{itemize} \\	
...
% Boomerang https://github.com/akamai/boomerang/blob/master/doc/methodology.md
