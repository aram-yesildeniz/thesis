...
- The entities of web applications are in general Frontend, Backend and Network which connects them
...
- I will not go into details here, just cite Grigorik and in the end important is the impact on speed
...
- Now the browser renders the page: CRP in section X
