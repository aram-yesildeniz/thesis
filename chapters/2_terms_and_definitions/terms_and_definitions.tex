...
\end{center}
\end{figure}
%TODO the red boxes seem to be wrong: Network is maybe only from DNS to Request ..? or even request is coming from the browser
% choose another word? Maybe navigation process...
...
Most often, the server will respond by sending back the index.html file, which then can be used by the browser to build the web site. % cite https://developer.mozilla.org/en-US/docs/Web/Performance/How_browsers_work
...
Browser requests non-blocking resources and continues parsing % cite How Browsers Work https://developer.mozilla.org/en-US/docs/Web/Performance/How_browsers_work
...
Is defined here % footnote https://drafts.csswg.org/cssom/
