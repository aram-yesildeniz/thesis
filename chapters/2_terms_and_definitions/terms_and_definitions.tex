...
Navigation Timing timestamps are exposed via the PerformanceNavigationTiming interface and can be retrieved via $window.performance.getEntriesByType("navigation")$. % cite https://www.w3.org/TR/navigation-timing-2/
...
As described above, Resource Timing exposes timing information for all other resources than the main document.
