...
The document creation follows a "recommendation track", which describes the hurdles a document needs to overcome in order to turn from an idea into a final recommendation and web standard to an concrete API which browser vendors implement. %cite  https://www.w3.org/2020/Process-20200915/#rec-track
The phases in the recommendation track are described by "maturity levels" of the document:
The document starts as the First Public Working Draft -> Working Draft (WD)-> Candidate Recommendations (CR)-> Proposed Recommendation, and finally the publication as a W3C Recommendation. (REC)  % cite https://www.w3.org/2015/Process-20150901/#maturity-levels
...
The Web Performance Working Group is one of them and responsible "to provide methods to measure aspects of application performance of user agent features and APIs" \footnote{\url{https://www.w3.org/webperf/} [11.07.2021]}.
...
%TODO what do i really need from this section`?
% there are no metrics directly coming from this

%"Level 2" is older but already recommendation from date % https://www.w3.org/TR/hr-time-2/
%Newest spec from date is working draft % https://www.w3.org/TR/hr-time-3/
...
%  [All Timestamps from Navigation and Resource Timing]
...
%- level 1 is recommendation from December 2013 % https://www.w3.org/TR/2013/REC-performance-timeline-20131212/
%- level 2
