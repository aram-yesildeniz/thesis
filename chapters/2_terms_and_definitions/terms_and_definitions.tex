...
First Public Working Draft $\,\to\,$ Working Draft (WD) $\,\to\,$ Candidate Recommendations (CR) $\,\to\,$ Proposed Recommendation $\,\to\,$ W3C Recommendation (REC).  % cite https://www.w3.org/2015/Process-20150901/#maturity-levels
...
Long Tasks API 1 is a First Public Working Draft from September 2017.
Toe goal of the API is to detect "long tasks", this are tasks that occupy main thread.
