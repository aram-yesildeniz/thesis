...
%TODO put this stuff in table with explanations
...
\begin{center}
	...
	\hline
	redirectCount & ... \\
	\caption{Navigation Timing Level 2 Attributes in PerformanveNavigationTiming Interface} % needs to go inside longtable environment
...
%TODO check if navigation 1 or 2 is used, because navigationStart is not in level 2
% -> there is a substitution for navigationStart in level 2
