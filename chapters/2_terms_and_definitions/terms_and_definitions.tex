...
The values are exposed by the PerformanceResourceTiming interface and can be retrieved via $performance.getEntriesByType("resource")$.
...
\paragraph{Navigation and Resource Timing Level 2 Time Values}
...
What exactly are they? time stamp, event, browser event? Dom event ?
...
\begin{center}
	...
	\hline
	\multicolumn{2}{|c|}{ \cellcolor{lightgrey} Other Navigation Timings} \\
	\hline
	type & ... \\
	\hline
	redirectCount & ... \\
	...
	\hline
	\multicolumn{2}{|c|}{ \cellcolor{lightgrey} Other Resource Timings} \\
	\hline
	initiatorType & ... \\
	\hline
	nextHopProtocol & ... \\
