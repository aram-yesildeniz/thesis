...
According to the documentation, there are two main categories for performance metrics: Page-Level metrics and Request-Level metrics. % footnote https://docs.webpagetest.org/
...
In the documentation, these metrics are called "High-Level Metrics". % footnote https://docs.webpagetest.org/getting-started/
...
Fully Loaded is a WPT-specific metric and indicates the time when there has been no network activity for two seconds after Document Complete. % f0otnote https://docs.webpagetest.org/getting-started/
...
Grades are a "set of web performance must-haves to which [...] pages should adhere" and they "evaluate the page data captured by the test and show whether the page has passed or failed a certain goal". % Viscomi p 51
The grades calculated by WPT are listed in table X.
Detailed explanations are described in the documentation.
% footnote https://docs.webpagetest.org/getting-started/
