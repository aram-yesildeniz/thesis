...
To tackle the research question, a synthetic monitoring tool has to be used to measure common performance metrics.
The tool used is WebPageTest (WPT) and will hence briefly discussed here.

"WebPageTest is a web performance tool providing deep diagnostic information about how a page performs under a variety of conditions." % https://docs.webpagetest.org/


% 2011 Grigorik https://hpbn.co/primer-on-web-performance/
open source
free web service
provides a system for testing the performance
results are then available through a web interface
...
was acquired in September of 2020 by Catchpoint https://www.catchpoint.com/webpagetest-joins-catchpoint

Problem/SOlution: THey had very fast internet, and needed a way to analyze and share the performance that users experienced in Internet Explorer, on Windows, and in the slow connectivity environments that existed at the time
core mission has been very consistent: to provide detailed information to developers about the loading performance of their pages in a realistic end user environment.
test locations provided by over fifty companies and individuals.

It doesn’t require installing anything, all you need is a browser. 
makes it easy to save and share results
...
"WebPageTest is the leading web performance tool in the world today"
...
will see in approach how I used private instance
...
% Metrics measured by WPT discussed in section X.
