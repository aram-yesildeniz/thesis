...
%TODO add why is it important... used for metrics, as benchmark, etc.: CHeck in text where crux is used.
...
As will be discussed in Section X, I will use a RUM tool to measure and compare performance metrics in the context of a controlled experiment, which will help answer the research question.
...
GA is today by far the most used analysis tool today.
\footnote{\url{https://w3techs.com/technologies/overview/traffic_analysis} [05.08.2021]}

% https://onward.justia.com/history-of-google-analytics/ \cite{2021Franco}
Version 1: Urchin 2005
Version 2: Classic GA in 2007
Version 3: Universal Analytics in 2013
Version 4: GA4 in 2020

I use UA as explained in section X.
...
\footnote{\url{https://marketingplatform.google.com/about/analytics/features/} [05.08.2021]}

analytics intelligence: analysis of collected data
Reporting: Real-time reports, audience reports, conversion reports, ...
Data Analysis and Visualization: visualization and monitoring, segmentation

Data tracked relevant for web performance is discussed in section X.
...
page tagging as explained in section X.

Real life examples and other aspects such as the position of the script are discussed in section X.
