...
\begin{table}[h]
	...
	\hline
	Element- and Event Timing API & WICG proposals (unoffical drafts)  \\
...
Additionally, Google sets realistic thresholds, values that can be met and achieved by regular websites.
Thresholds are therefore modelled on available data.
For example, the best classification, "good", defined as delivering "high quality user experience", is defined in such a way that already 10\% of all websites surpass it.
...
While LCP and FID are described in milliseconds, CLS is a score.
...
Classification is based on the 75th percentile value of all page views:
...
\begin{table}[h]
	...
	\hline
	...  & is it x & is it aa & is itasd \\
	\hline
	Perceived load speed & ... & ... & ... \\
	\hline
	\end{tabular}
	\medskip
	\caption{Web Vitals Summary}
	\label{table:types_ecommerce}
\end{table}
