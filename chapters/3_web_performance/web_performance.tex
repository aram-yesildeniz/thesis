...
there is an unofficial specification by WICG % https://wicg.github.io/largest-contentful-paint/
...
source code is here % https://github.com/GoogleChrome/web-vitals/blob/main/src/getLCP.ts
% https://web.dev/lcp/


% https://medium.baqend.com/the-core-web-vital-largest-contentful-paint-just-changed-dramatically-b7bf5b7f17f3
...
% changelog https://chromium.googlesource.com/chromium/src/+/refs/heads/main/docs/speed/metrics_changelog/lcp.md
...
Only cosidering first input because...
...
source code is here % https://github.com/GoogleChrome/web-vitals/blob/main/src/getFID.ts
