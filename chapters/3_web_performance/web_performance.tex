...
And with performance being a factor in Google search rankings, Web Vitals become automatically important for website operators. % https://developers.google.com/web/updates/2018/07/search-ads-speed

% [Evolving]

The set and definitions of Web Vitals metrics are not cut in stone but rather of evolving nature.
The definitions, calculations, recommended thresholds or even metrics itself may change over time, as the WWW is constantly changing. % https://web.dev/vitals/
While currenty, Web Vitals are primarily concerned with web performance, other aspects of user experience, such as security, privacy or accessibility, will be incorporated. % https://www.youtube.com/watch?v=iNfz9tg-wyg&ab_channel=GoogleChromeDevelopers
...
Contrary to navigation timing metrics, the Web Vitals focus are users, and each question is a perspective or facet of user experience.
...
Apart from the key questions, Google identifies different aspects, or types, of performance:
...
Those types guide as an additional frame to organise, structure and integrate Web Vitals. % https://web.dev/user-centric-performance-metrics/
...
%Google also has tool support to capture web vitals.
%They are not covered here.
%For reference, the official JS library is here % https://github.com/GoogleChrome/web-vitals
...
% Which metrics are part of web vitals ? https://github.com/GoogleChrome/web-vitals
% not clear. on the specific pages some metrics are being consireded web vitals without being in the library
