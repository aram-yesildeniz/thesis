...
% Bytes FV: as expected, we load a little bit more JS (the GA alanytics script). The rest is the same.
% Requests FV: additionally to the more JS request in P1, some more resources are fetched, which are requested by the analyitcs script (check this again)
