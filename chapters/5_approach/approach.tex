...
Many other IV could be chosen and they could reflect variables of the tracking script itself, the website, or the infrastructure around it.

% [Script]

Regarding additional IVs for the tracking script, variables may reflect the quality of the tracking script, e.g. which kind of user data it is collecting.
Other variables may compare different versions and implementations of the same RUM script.

% [Website]

Possible variables for the website may reflect how it is implemented, how the code is structured, which libraries are used, how many resources such as images and videos are being loaded, how they are arranged, how the CSS is handled, etc.
